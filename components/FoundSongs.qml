...
Item {
    ...
    function resolve(text) {
        Scripts.get_track(text);
        get_fav();
        get_lib();
    }

    function get_fav() {
        Scripts.get_fav_songs(uid, 'search');
    }
    function get_lib() {
        Scripts.get_lib_songs(uid, 'search');
    }
    ...
    ListView {
        ...
        delegate: ListItem.Empty {
            ...
            MouseArea {
                ...
                onClicked: {
                    queueModel.clear();
                    for (var i = 0; i < foundsongsModel.count; i++) {
                        queueModel.append(foundsongsModel.get(i));
                    }
                        ...
                        Item {
                            ...
                            Rectangle {
                                ...
                                MouseArea {
                                    ...
                                    onClicked: {
                                        if (is_fav == 1) {
                                            Scripts.remove_from_fav(id, 'search');
                                        } else {
                                            Scripts.add_to_fav(id, 'search');
                                        }
                                    }
                                }
                            }
                            Rectangle {
                                ...
                                MouseArea {
                                    ...
                                    onClicked: {
                                        if (is_lib == 1) {
                                            Scripts.remove_from_lib(id, albumId, artistId, uid, 'search');
                                        } else {
                                            var song_data = [{
                                                'songID' : id,
                                                'songName' : title,
                                            ...
                                            Scripts.add_to_lib(song_data, 'search');
                                        }
                                    }
                                }
                            }
