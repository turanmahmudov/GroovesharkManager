                ...
                Column {
                    ...
                    Row {
                        ...
                        Label {
                            id: awareLabel
                            width: units.gu(35)
                            text: i18n.tr("The app is <b>not</b> provided by Grooveshark.")
                    ...
                    Row {
                        ...
                        Label {
                            id: donateLabel
                            width: units.gu(35)
                            text: i18n.tr("Buy <b>Grooveshark Manager Support</b> to donate me.")
                            textFormat: Text.RichText
                            wrapMode: Text.WordWrap
                        }
                    }
