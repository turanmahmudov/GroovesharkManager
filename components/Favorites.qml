...
Item {
    ...
    function get_fav() {
        Scripts.get_fav_songs(uid, 'favorites');
        get_lib();
    }
    function get_lib() {
        Scripts.get_lib_songs(uid, 'favorites');
    }
    ...
    ListView {
            ...
            MouseArea {
                ...
                onClicked: {
                    ...
                    for (var i = 0; i < favoritesModel.count; i++) {
                        queueModel.append(favoritesModel.get(i));
                    }
                        ...
                        Item {
                            ...
                            Rectangle {
                                ...
                                MouseArea {
                                    ...
                                    onClicked: {
                                        if (is_fav == 1) {
                                            Scripts.remove_from_fav(id, 'favorites');
                                        } else {
                                            Scripts.add_to_fav(id, 'favorites');
                                        }
                                    }
                                }
                            }
                            Rectangle {
                                ...
                                MouseArea {
                                    ...
                                    onClicked: {
                                        if (is_lib == 1) {
                                            Scripts.remove_from_lib(id, albumId, artistId, uid, 'favorites');
                                        } else {
                                            var song_data = [{
                                                'songID' : id,
                                                'songName' : title,
                                            ...
                                            Scripts.add_to_lib(song_data, 'favorites');
                                        }
                                    }
                                }
                            }
        ...
        PullToRefresh {
            refreshing: favoritesModel.count == 0 && favorites.finished == false
            onRefresh: get_fav()
        }
    }
    Scrollbar {
        flickableItem: favorites
    }

    Item {
        id: indicat
        anchors.centerIn: parent
        opacity: favoritesModel.count == 0 && favorites.finished == false ? 1 : 0
    ...
    Item {
        id: noitem
        visible: favoritesModel.count == 0 && favorites.finished == true ? true : false
        ...
        Label {
            ...
            anchors.centerIn: parent
            fontSize: "large"
            text: i18n.tr("<b>You have not favorited any songs.</b>")
        }
    }
}
